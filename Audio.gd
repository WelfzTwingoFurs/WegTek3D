...
const car0G = preload("res://audio/car/TD3/car_engine_start.wav")
const car1G = preload("res://audio/car/ecosport/car_engine_start.wav")
const car2G = preload("res://audio/car/enduro/car_engine_start.wav")
